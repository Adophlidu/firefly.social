...
// Read package.json to know which packages are direct dependencies (monorepo root + web app)
const pkgJson = JSON.parse(readFileSync(path.join(repoRoot, 'package.json'), 'utf-8'));
const webPkgJson = JSON.parse(readFileSync(path.join(repoRoot, 'apps/web/package.json'), 'utf-8'));
const directDeps = new Set([
    ...Object.keys(pkgJson.dependencies || {}),
    ...Object.keys(pkgJson.devDependencies || {}),
    ...Object.keys(webPkgJson.dependencies || {}),
    ...Object.keys(webPkgJson.devDependencies || {}),
]);
...
const docsDir = path.join(repoRoot, 'apps/web/docs');

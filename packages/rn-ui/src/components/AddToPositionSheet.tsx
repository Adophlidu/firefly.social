                    ...
                    <>
                        ...
                        <YStack borderWidth={1} borderColor="$borderSubdued" borderRadius={16} paddingVertical={12}>
                                ...
                                <XStack alignItems="center" justifyContent="space-between">
                                    ...
                                    >
                                        <XStack alignItems="center">
                                            <Text color="$text" fontSize={14} lineHeight={18} fontWeight={500}>
                                                $
                                            </Text>
                                            <Input
                                                unstyled
                            ...
                            >
                                ...
                                <Text color="$text" fontSize={14} lineHeight={18} fontWeight={500} textAlign="right">
                        ...
                        <XStack gap={16}>
                            ...
                            <Button
                                ...
                                flex={1}
                                height={48}
                                backgroundColor={isValid ? '$text' : '$bgDisabled'}
                                borderRadius={96}
                                alignItems="center"
                                justifyContent="center"
                            ...
                            >
                                <Text
                                    color={isValid ? '$bgHover' : '$textTertiary'}
                                    fontSize={16}
                                    lineHeight={24}
                                    fontWeight={700}
                                >

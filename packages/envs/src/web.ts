...
const ExternalEnvSchema = z.object({
    ...
    NEXT_PUBLIC_SNAP: z.nativeEnum(STATUS).default(STATUS.Enabled),
    ...
    NEXT_PUBLIC_SHORT_LINK: z.nativeEnum(STATUS).default(STATUS.Enabled),
    ...
    NEXT_PUBLIC_WORLD_CUP: z.nativeEnum(STATUS).default(STATUS.Enabled),
...
export const envs = {
    ...
    external: ExternalEnvSchema.parse({
        ...
        NEXT_PUBLIC_SNAP: process.env.NEXT_PUBLIC_SNAP,
        ...
        NEXT_PUBLIC_SHORT_LINK: process.env.NEXT_PUBLIC_SHORT_LINK,
        ...
        NEXT_PUBLIC_WORLD_CUP: process.env.NEXT_PUBLIC_WORLD_CUP,

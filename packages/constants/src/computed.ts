...
export const WEB_WALLET_PROFILE_TAB_TYPES: Record<NetworkType, WalletProfileCategory[]> = {
...
export const SUPPORTED_PREVIEW_MEDIA_TYPES: AttachmentType[] = [AttachmentType.Image, AttachmentType.AnimatedGif];

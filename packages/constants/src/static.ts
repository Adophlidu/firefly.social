...
export const EXCEPTION_TRACKER_URL = 'https://firefly-exception-tracker.r2d2.to';
...
// Hyperliquid tick/lot size — https://hyperliquid.gitbook.io/hyperliquid-docs/for-developers/api/tick-and-lot-size#perp-price-examples

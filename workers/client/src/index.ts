...
import type { AppType as BskyIdentityAppType } from '@dimensiondev/workers-bsky-identity';
import type { AppType as EnsAppType } from '@dimensiondev/workers-ens';
import type { AppType as FarcasterMessageAppType } from '@dimensiondev/workers-farcaster-message';
...
// ────────────────────────────────────────────────────────────────────────────
export const bskyIdentityWorker = hc<BskyIdentityAppType>(FIREFLY_WORKER_HOST);
export const ensWorker = hc<EnsAppType>(FIREFLY_WORKER_HOST);
export const farcasterMessageWorker = hc<FarcasterMessageAppType>(FIREFLY_WORKER_HOST);

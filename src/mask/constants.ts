import V1ABI from '@/mask_pkgs/web3-contracts/abis/HappyRedPacketV1.json' with { type: 'json' };
import V2ABI from '@/mask_pkgs/web3-contracts/abis/HappyRedPacketV2.json' with { type: 'json' };

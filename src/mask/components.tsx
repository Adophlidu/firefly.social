...
export function LoadingBase(props: LoadingBaseProps) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 36 36" {...props} className="animate-spin">
            <g fill="currentColor">
                <path
                    ...
                    opacity=".5"
                />
                <path d="M18 32.85c0 .911-.74 1.658-1.647 1.568A16.5 16.5 0 1 1 31.595 8.65c.517.751.218 1.76-.58 2.199-.799.439-1.794.14-2.33-.598a13.2 13.2 0 1 0-12.33 20.846c.903.114 1.645.842 1.645 1.753Z" />
            </g>
        </svg>
    );
}

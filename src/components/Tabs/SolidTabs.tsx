...
export function SolidTabs<T = unknown>({ data, link, isSelected, itemRender, onChange }: SolidTabsProps<T>) {
    return (
        <div>
            <ul className="no-scrollbar relative inline-flex h-10 max-w-full items-center overflow-y-auto rounded-md border border-secondaryLine bg-thirdBottom px-[5px] py-1">

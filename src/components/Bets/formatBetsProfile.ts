...
export function formatPolymarketProfile(data: PolymarketProfileData): BetsProfileDataForUI {
    return {
...
export function formatOpinionProfile(data: BetPortfolioItem): BetsProfileDataForUI {
    return {
        balance: data.balance,

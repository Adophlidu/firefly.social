...
export function SearchRecommendation(props: SearchRecommendationProps) {
    ...
    const containerClasses = classNames(
        'max:max-h-[calc(100vh-59px)] absolute -inset-x-[1px] top-10 z-[1000] flex w-[calc(100%_+_2px)] flex-col overflow-auto overflow-hidden bg-white shadow-[0_4px_30px_0_rgba(0,0,0,0.10)] dark:border dark:border-line dark:bg-primaryBottom',
        {

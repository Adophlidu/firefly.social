        ...
        <>
            ...
            <ClickableButton
                ...
                className={classNames(
                    'flex h-8 flex-shrink-0 items-center justify-center whitespace-nowrap rounded-lg border border-lightMain px-5 text-medium font-bold leading-5 text-lightMain',
                    className,
                )}
            >
                {children}

...
import { LoginModalRef, MyWalletsModalRef, WalletConnectModalRef } from '@/modals/controls.js';
    ...
    return (
        <div className="flex flex-col overflow-auto rounded-xl md:max-h-[535px] md:w-[500px]">
            <div className="flex w-full flex-col overflow-auto md:min-h-[300px]">
                {profiles.length ? (
                    <div className="flex flex-grow flex-col gap-4 overflow-auto bg-primaryBottom px-4">

...
import { AccountForm } from '@/legacy/[locale]/(whiteboard)/signup/pages/AccountForm.js';
import { playSignupAudio, preloadSignupAudio } from '@/legacy/[locale]/(whiteboard)/signup/pages/audio.js';
import { GuidePage } from '@/legacy/[locale]/(whiteboard)/signup/pages/GuidePage.js';
import { PageBackground } from '@/legacy/[locale]/(whiteboard)/signup/pages/PageBackground.js';
import { SocialLoginPage } from '@/legacy/[locale]/(whiteboard)/signup/pages/SocialLoginPage.js';
import { SuccessPage } from '@/legacy/[locale]/(whiteboard)/signup/pages/SuccessPage.js';

...
import { openEditFireflyProfileModal } from '@/controllers/openEditFireflyProfileModal.js';
import { closeLoginModal } from '@/controllers/openLoginModal.js';
import { openLogoutModal } from '@/controllers/openLogoutModal.js';
import { openAndWaitForClosePasswordModal } from '@/controllers/openPasswordModal.js';
import { openSignInToFireflyAppModal } from '@/controllers/openSignInToFireflyAppModal.js';
    ...
    const [{ loading: queryMetricsStatusLoading }, queryMetricsStatus] = useAsyncFn(async () => {
        try {
            ...
            if (status.hasSetPasscode) {
                ...
                await openAndWaitForClosePasswordModal({

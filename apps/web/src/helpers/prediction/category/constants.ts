...
export const LEADING_PRIMARY_SLUGS = ['trending', 'new'] as const;
...
export type PredictionCategoryTab = typeof PREDICTION_CATEGORY_GAMES_TAB | typeof PREDICTION_CATEGORY_PROPS_TAB;

import type { PredictionPlatform, ProfileCategory, ProfilePageSource, Source } from '@dimensiondev/enums';
import urlcat from 'urlcat';

import type { SignupStep, TipsDetailViewType } from '@/constants/enum.js';

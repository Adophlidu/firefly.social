// pino cannot run in the Workers runtime (it spawns worker threads via
// thread-stream). Server code paths that still reach pino (e.g. the
// server-side Logger implementation) get this console-backed stub instead.

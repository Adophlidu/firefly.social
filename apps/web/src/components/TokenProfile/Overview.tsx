    ...
    return (
        <div {...rest}>
            <div className="grid grid-cols-3 gap-3">
                <div className="bg-lightBg flex flex-col gap-1 rounded-xl p-4">
                    <p className="font-inter text-main text-base font-bold leading-6">
                        {marketCap ? formatMarketCap(marketCap, 2, '$') : fdv ? formatMarketCap(fdv, 2, '$') : '-'}
                    </p>
                    <h3 className="font-inter text-second text-[13px] leading-[18px] underline">
                        <Tooltip
                            placement="top"
                            content={
                ...
                <div className="bg-lightBg flex flex-col gap-1 rounded-xl p-4">
                    ...
                    <h3 className="font-inter text-second truncate text-[13px] leading-[18px]">
                ...
                <div className="bg-lightBg flex flex-col gap-1 rounded-xl p-4">
                    ...
                    <h3 className="font-inter text-second inline-block text-[13px] leading-[18px] underline">
                        <Tooltip

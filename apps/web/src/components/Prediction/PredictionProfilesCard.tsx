...
export function PredictionProfilesCard({ address }: PredictionProfilesCardProps) {
    ...
    return (
        ...
        >
            {isLoading ? (
                <div className="bg-primaryBottom flex animate-pulse justify-evenly gap-3 rounded-xl p-3">
                    <div className="text-main flex flex-1 items-center gap-2">
                        <div className="bg-third size-8 shrink-0 rounded-full" />
                        <div className="flex h-9 flex-1 flex-col justify-between">
                            <div className="bg-third h-4 w-full max-w-[96px] shrink-0 rounded-[4px]" />
                            <div className="bg-third flex h-4 w-1/2 max-w-[64px] items-center rounded-[4px]" />
                        </div>
                    </div>
                    <div className="flex h-9 flex-1 flex-col items-end justify-between">
                        <div className="bg-third h-4 w-1/2 max-w-[64px] shrink-0 rounded-[4px]" />
                        <div className="bg-third ml-auto flex h-4 w-full max-w-[128px] items-center rounded-[4px]" />
                    </div>
                    <div className="flex h-9 flex-1 flex-col items-end justify-between">
                        <div className="bg-third h-4 w-1/2 max-w-[64px] shrink-0 rounded-[4px] text-sm font-semibold" />
                        <div className="bg-third ml-auto flex h-4 w-full max-w-[128px] items-center rounded-[4px]" />
                    </div>
                </div>
            ) : (

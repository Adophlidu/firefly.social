...
export const SideBarForDesktop = memo(function SideBarForDesktop() {
    return (
        <aside className="fixed inset-y-0 z-30 flex h-svh min-h-[626px] flex-col max-md:hidden md:w-[235px] lg:w-[289px]">
            <div className="border-line flex grow flex-col gap-y-4 border-r px-3 lg:px-6">

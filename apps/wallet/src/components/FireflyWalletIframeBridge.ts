...
export const FireflyWalletIframeBridge = memo(function IframeBridge() {
    ...
    useEffect(() => {
        ...
        const allEvents: {
            ...
            [IframeBridgeMethod.FIREFLY_WALLET_GENERATE_SHARE_IMAGE]: async () => {
                // Host-only: the share image is rendered by the host (web) and requested from here.
                throw new NotImplementedError('Share image is generated by the host app');
            },

// Native token address: 0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee (EVM)
// Native token address: 11111111111111111111111111111111 (Solana)
...
export const DEFAULT_SWAP_TOKENS: DefaultSwapTokenPair[] = [
    {
        chainId: 1,
        chainName: 'Ethereum',
        first: { symbol: 'ETH', contractAddress: '0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee', decimals: 18 },
        second: { symbol: 'USDC', contractAddress: '0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48', decimals: 6 },
    },
    {
        chainId: 56,
        chainName: 'Binance Smart Chain',
        first: { symbol: 'BNB', contractAddress: '0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee', decimals: 18 },
        second: { symbol: 'USDC', contractAddress: '0x8ac76a51cc950d9822d68b83fe1ad97b32cd580d', decimals: 6 },
    },
    {
        chainId: 137,
        chainName: 'Polygon',
        first: { symbol: 'POL', contractAddress: '0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee', decimals: 18 },
    ...
    },
    {
        chainId: 43114,
        chainName: 'Avalanche',
        first: { symbol: 'AVAX', contractAddress: '0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee', decimals: 18 },
    ...
    },
    {
        chainId: 250,
        chainName: 'Fantom',
        first: { symbol: 'FTM', contractAddress: '0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee', decimals: 18 },
    ...
    },
    {
        chainId: 5000,
        chainName: 'Mantle',
        first: { symbol: 'MNT', contractAddress: '0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee', decimals: 18 },
    ...
    },
    {
        chainId: 501,
        chainName: 'Solana',
        first: { symbol: 'SOL', contractAddress: '11111111111111111111111111111111', decimals: 9 },

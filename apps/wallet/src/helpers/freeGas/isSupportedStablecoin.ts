...
const STABLECOIN_ADDRESSES: Record<AvailableChainId, { usdt: string; usdc: string }> = {
    [EthereumChainId.Mainnet]: {
...
export function isSupportedStablecoin(chainId: EthereumChainId, tokenAddress: string): boolean {
    const addresses = STABLECOIN_ADDRESSES[chainId as AvailableChainId];

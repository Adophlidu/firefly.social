...
function SelectTokenPage() {
    const search = sendTokensSearchSchema.parse(parseSearchParams(useSearch()));
    ...
    }, [data, isLoading, navigate, search.amount, search.chain, search.to, search.token, setToken, setValue]);
